...
namespace QuantConnect.Tests.Algorithm.Framework.Portfolio
{
    ...
    public class MeanVarianceOptimizationPortfolioConstructionModelTests
    {
        ...
        [TestCase(Language.CSharp, PortfolioBias.Short, 0.1, -0.1)]
        [TestCase(Language.Python, PortfolioBias.Short, 0.1, -0.1)]
        public void PortfolioBiasIsRespected(Language language, PortfolioBias bias, decimal magnitude1, decimal magnitude2)
        {
        ...
        [TestCase(Language.CSharp, InsightDirection.Up, InsightDirection.Up, 0, 0, 4986, 4986)]
        [TestCase(Language.Python, InsightDirection.Up, InsightDirection.Up, 0, 0, 4986, 4986)]
        [TestCase(Language.CSharp, InsightDirection.Up, InsightDirection.Up, 0.1, -0.1, 31, 63)]
        [TestCase(Language.Python, InsightDirection.Up, InsightDirection.Up, 0.1, -0.1, 31, 63)]
        [TestCase(Language.CSharp, InsightDirection.Up, InsightDirection.Down, 0.1, 0.1, 4986, 4986)]
        [TestCase(Language.Python, InsightDirection.Up, InsightDirection.Down, 0.1, 0.1, 31, 63)]
        [TestCase(Language.CSharp, InsightDirection.Up, InsightDirection.Up, 0, -0.1, 4986, 47)]
        [TestCase(Language.Python, InsightDirection.Up, InsightDirection.Up, 0, -0.1, 47, 47)]
        [TestCase(Language.CSharp, InsightDirection.Up, InsightDirection.Up, 0, 0.1, 9969, 0)]
        [TestCase(Language.Python, InsightDirection.Up, InsightDirection.Up, 0, 0.1, 9969, 0)]
