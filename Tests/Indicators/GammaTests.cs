...
namespace QuantConnect.Tests.Indicators
{
    ...
    public class GammaTests : OptionBaseIndicatorTests<Gamma>
    {
        protected override IndicatorBase<IndicatorDataPoint> CreateIndicator()
            => new Gamma("testGammaIndicator", _symbol, 0.053m, 0.0153m);
        ...
        protected override OptionIndicatorBase CreateIndicator(IRiskFreeInterestRateModel riskFreeRateModel, IDividendYieldModel dividendYieldModel)
            => new Gamma("testImpliedVolatilityIndicator", _symbol, riskFreeRateModel, dividendYieldModel);
        ...
        public void ComparesAgainstExternalData(string fileName, double errorMargin = 0.001, int column = 4)
        {
            var path = Path.Combine("TestData", "greeks", $"{fileName}.csv");
            var symbol = ParseOptionSymbol(fileName);
            var underlying = symbol.Underlying;

            var indicator = new Gamma(symbol, 0.053m, 0.0153m);
            RunTestIndicator(path, indicator, symbol, underlying, errorMargin, column);
        }

        [TestCase("SPY230811C00430000", 0.003)]
        [TestCase("SPY230811C00450000", 0.002)]
        [TestCase("SPY230811C00470000")]
        [TestCase("SPY230811P00430000")]
        [TestCase("SPY230811P00450000")]
        [TestCase("SPY230811P00470000", 0.012)]
        [TestCase("SPY230901C00430000")]
        [TestCase("SPY230901C00450000", 0.002)]
        [TestCase("SPY230901C00470000")]
        [TestCase("SPY230901P00430000")]
        [TestCase("SPY230901P00450000")]
        [TestCase("SPY230901P00470000", 0.011)]

        public void ComparesAgainstExternalDataCRRModel(string fileName, double errorMargin = 0.001, int column = 4)
        {
            var path = Path.Combine("TestData", "greeks", $"{fileName}.csv");
            var symbol = ParseOptionSymbol(fileName);
            var underlying = symbol.Underlying;

            var indicator = new Gamma(symbol, 0.053m, 0.0153m, OptionPricingModelType.BinomialCoxRossRubinstein,
        ...
        public void ComparesAgainstExternalDataAfterReset(string fileName, double errorMargin = 0.001, int column = 4)
        {
            var path = Path.Combine("TestData", "greeks", $"{fileName}.csv");
            var symbol = ParseOptionSymbol(fileName);
            var underlying = symbol.Underlying;
        ...
        [TestCase(23.753, 450.0, OptionRight.Call, 60, 0.0070)]
        [TestCase(35.830, 450.0, OptionRight.Put, 60, 0.0042)]
        [TestCase(33.928, 470.0, OptionRight.Call, 60, 0.0066)]
        [TestCase(6.428, 470.0, OptionRight.Put, 60, 0.0083)]
        [TestCase(3.219, 430.0, OptionRight.Call, 60, 0.0134)]
        [TestCase(47.701, 430.0, OptionRight.Put, 60, 0.0042)]
        [TestCase(16.528, 450.0, OptionRight.Call, 180, 0.0124)]
        [TestCase(21.784, 450.0, OptionRight.Put, 180, 0.0059)]
        [TestCase(35.207, 470.0, OptionRight.Call, 180, 0.0068)]
        [TestCase(0.409, 470.0, OptionRight.Put, 180, 0.0059)]
        [TestCase(2.642, 430.0, OptionRight.Call, 180, 0.0185)]
        ...
        public void ComparesGammaOnBSMModel(decimal price, decimal spotPrice, OptionRight right, int expiry, double refGamma)
        {
            ...
            var indicator = new Gamma(symbol, 0.053m, 0.0153m, optionModel: OptionPricingModelType.BlackScholes);
            ...
            Assert.AreEqual(refGamma, (double)indicator.Current.Value, 0.0001d);
        }

        // Reference values from QuantLib
        [TestCase(23.753, 450.0, OptionRight.Call, 60, 0.0070)]
        [TestCase(35.830, 450.0, OptionRight.Put, 60, 0.0043)]
        [TestCase(33.928, 470.0, OptionRight.Call, 60, 0.0066)]
        [TestCase(6.428, 470.0, OptionRight.Put, 60, 0.0085)]
        [TestCase(3.219, 430.0, OptionRight.Call, 60, 0.0134)]
        [TestCase(47.701, 430.0, OptionRight.Put, 60, 0.0043)]
        [TestCase(16.528, 450.0, OptionRight.Call, 180, 0.0124)]
        [TestCase(21.784, 450.0, OptionRight.Put, 180, 0.0065)]
        [TestCase(35.207, 470.0, OptionRight.Call, 180, 0.0068)]
        [TestCase(0.409, 470.0, OptionRight.Put, 180, 0.0071)]
        [TestCase(2.642, 430.0, OptionRight.Call, 180, 0.0185)]
        [TestCase(27.772, 430.0, OptionRight.Put, 180, 0.0085)]
